...
public class ExampleUsers extends LinkedList<User>{
	...
	public ExampleUsers() {
		...
		CurrentAccount curr1 = new CurrentAccount("1846673023", "CompteLewis", user1, new Date(110, 12, 15), 2341, 0, 500);
		CurrentAccount curr2 = new CurrentAccount("2403483473", "Compte Fiona", user2, new Date(115, 5, 20), 6434, 0, 300);
		...
		LivretAAccount livret1 = new LivretAAccount("1633491044", "LivretA", user1, new Date(119, 4, 10), 5000, 0, 300, 22950);
		LivretAAccount livret2 = new LivretAAccount("5539111274", "LivretA", user2, new Date(110, 10, 5), 1500 , 0, 500, 22950);
		
		Card card1 = new Card(user1, "2345", "32948749833");
		Card card2 = new Card(user2, "3456", "38375093728");
		
		PermanentTransfer transfer1 = new PermanentTransfer(curr1, payee1, 50, new Date(119, 5, 10), TransferRegularity.THREE_MONTHLY);
		PermanentTransfer transfer2 = new PermanentTransfer(curr2, payee2, 1000, new Date(115, 3, 15), TransferRegularity.ANNUAL);
		PermanentTransfer transfer3 = new PermanentTransfer(curr2, payee3, 150, new Date(116, 10, 5), TransferRegularity.MONTHLY);
		
		Transaction transaction1 = new Transaction(random1, -5, 0, new Date(120, 1, 1), new CardTransaction(card1));
		Transaction transaction2 = new Transaction(random3, -20, 0, new Date(120, 2, 2), new PermanentTransferTransaction());
		Transaction transaction3 = new Transaction(random2, -10, 1, new Date(120, 4, 15), new CardTransaction(card2));
		Transaction transaction4 = new Transaction(random3, -30, 0, new Date(120, 3,3), new CardTransaction(card2));
		Transaction transaction5 = new Transaction(random4, -40, 1, new Date(), new PermanentTransferTransaction());
		
		Loan loan1 = new Loan(10000, 12000, 0.05, 4000, 0, new Date(120, 10, 10), new Date(130, 10, 10));
		Loan loan2 = new Loan(2000, 2500, 0.05, 2000, 1500, new Date(117, 1, 1), new Date(122, 1,1));
